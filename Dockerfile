...
RUN    mkdir -p /var/www/webmentions /var/lib/webmentiond/frontend && apk add --no-cache php-fpm php-xmlrpc php-curl php-dom sqlite-dev curl findutils git bash jq  openssh-client inotify-tools nginx apache2-utils python3 # golang
